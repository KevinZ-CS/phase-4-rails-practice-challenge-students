class InstructorsController < ApplicationController
    ...
    def index
        render json: Instructor.all, adapter: nil,  #adapter nill turns off serializer gem and allows us to use built in serializer but will give dates so you'll exlcude withb except
